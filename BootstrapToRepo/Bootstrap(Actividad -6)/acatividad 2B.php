...
<html>
 ...
 <link rel="stylesheet" href="font-awesome-4.7.0/css/font-awesome.min.css">
  ...
  <div class="container">
      ...
      <a class="navbar-brand" href="#"> Computadoras </a>
      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header">
            ...
            onclick="add()">Añadir usuario</button>
          </div>
          <div class="card-body">
              ...
              <tr>
                ...
                <td>
                  <button data-info='<?= json_encode($users)?>'  data-toggle="modal" data-target="#exampleModal" type="button" class="btn btn-warning" onclick="editar(this)" >
                    ...
                    <i type="" class="fa fa-pencil" name="" > </i>Editar
                  </button>
                  <button type="button" onclick="remove(<?= $users['id'] ?>, this)" class="btn btn-danger">
    ...
    <div class="modal-dialog modal-lg">
         ...
         <form method="POST" action="users" id="myForm" onsubmit="return validateRegister()">
  ...
  function editar(target){
    ...
    function add(){
      ...
      $("#action").val("store");
      document.getElmentById("myForm").eset();
    }
        ...
        .then((willDelete) => {
          if (willDelete) {
            ...
            $.ajax({
              ...
              type: 'POST',
              dataType: 'json',
              data: {action:'remove',users_id:id },
